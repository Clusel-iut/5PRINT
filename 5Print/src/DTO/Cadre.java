...
public class Cadre extends Impression{
	...
	public Cadre(int id_impression, Date date_impression, int nb_impression, Client client, Catalogue catalogue, int numero,
			float montant_total, boolean etat_impression, ArrayList<Photo> photos, String mise_en_page, String modele) {
